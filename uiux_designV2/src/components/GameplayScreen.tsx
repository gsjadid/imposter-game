      ...
      <div className="max-w-4xl w-full mx-auto relative z-10 flex-1 flex flex-col min-h-0">
        ...
        {onLeaveGame && (
          ...
          >
            <Button
              onClick={onLeaveGame}
              className="w-full h-10 sm:h-11 md:h-12 bg-gradient-to-r from-[var(--game-red)] to-[var(--game-orange)] hover:from-[var(--game-red)]/90 hover:to-[var(--game-orange)]/90 text-white shadow-xl shadow-red-500/30 border-0 text-sm sm:text-base"
            >
